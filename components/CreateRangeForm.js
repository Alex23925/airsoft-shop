...
export default function CreateForm(props) {
    ...
    const { data, error } = useSWR("/api/rangeweapons");
    ...
    let handleSubmit = async (e) => {
        ...
        mutate("/api/rangeweapons", { ...data, rangeweapon: itemData }, false);
        await axios
            .post("/api/rangeweapons/create", { rangeweapon: itemData })
            .then((res) => {
                console.log(res);
                console.log(res.data);
            });
        mutate("/api/rangeweapons");
    };
